...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/wangcheng-ios/A_Category"
  ...
  s.source       = { :git => "https://github.com/wangcheng-ios/A_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A_Category/Source/**/*.{h,m,swift}"
